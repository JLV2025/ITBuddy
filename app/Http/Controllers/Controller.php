...
/*! \mainpage ITBuddy Code Documentation
 *
 * \section intro_sec Introduction
 *
 * This documentation is designed to allow developers to easily understand
 * the backend code of ITBuddy. Familiarity with the PHP language is assumed,
 ...
 * information on how to install ITBuddy.
 *
 * To learn how to set up a development environment and get started developing for ITBuddy,
 * please see the [contributing documentation](https://snipe-it.readme.io/docs/contributing-overview).
 *
 * Only the ITBuddy specific controllers, models, helpers, service providers,
