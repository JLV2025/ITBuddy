...
return [
    ...
    'backups_restore_warning' => 'Wählen Sie die Wiederherstellung <small><span class="btn btn-xs btn-warning"><i class="text-white fas fa-retweet" aria-hidden="true"></i></span></small> um ein Backup wieder herzustellen. (Funktioniert derzeit nicht mit S3 Datenspeicher)<br><br>Die <strong>gesamte :app_name Datebank und alle Uploads werden mit den Inhalten des Backups überschrieben</strong>.  ',
    ...
    'color_settings_help' => 'Diese Einstellungen werden durchweg in ITBuddy verwendet. Benutzer haben die Möglichkeit, die Farbe von Links in ihren Account-Einstellungen individuell anzupassen, um eine optimale Lesbarkeit sicherzustellen.',
    ...
    'link_dark_color_help' => 'Wählen Sie eine Farbe, die genügend Kontrast für Personen bietet, die ITBuddy im Dunkel Modus verwenden.',
    'link_light_color' => 'Farbe der Links im Hell Modus',
    'link_light_color_help' => 'Wählen Sie eine Farbe, die genügend Kontrast für Personen bietet, die ITBuddy im Hell Modus verwenden.',
    ...
    'ldap_location' => 'LDAP-Standortfeld',
    ...
    'ldap_manager' => 'LDAP Manager Feld',
    ...
    'ldap_display_name_help' => 'Wenn es ein separates <code>displayName</code> Attribut in Ihrem LDAP/AD gibt, dann können Sie es hier abbilden, womit dieses dann für die Darstellung der Benutzernamen in ITBuddy verwendet wird.',
    ...
    'load_remote_help_text' => 'Deaktivieren Sie dieses Kästchen, wenn Ihre Installation keine Skripte aus dem externen Internet laden kann. Das verhindert, dass ITBuddy versucht, Bilder von Gravatar oder anderen externen Quellen zu laden.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Sofern hier eine URL angegeben ist, werden Benutzer automatisch zu dieser URL weitergeleitet, nachdem der Benutzer sich aus ITBuddy ausloggt. Dies ist nützlich, um die Benutzersitzung Ihres Authentifizierungsproviders korrekt zu beenden.',
    ...
    'show_images_in_email_help' => 'Deaktivieren Sie dieses Kontrollkästchen, wenn sich Ihre ITBuddy-Installation hinter einem VPN oder einem geschlossenen Netzwerk befindet und Benutzer außerhalb des Netzwerks keine Bilder von dieser Installation in ihre E-Mails laden können.',
    ...
    'snipe_version' => 'ITBuddy Version',
    'support_footer' => 'Fußzeile Support-Link ',
    'support_footer_help' => 'Geben Sie an, wer die Links zum ITBuddy Support-Info und Benutzerhandbuch sieht',
    'version_footer' => 'Version in in der Fußzeile ',
    'version_footer_help' => 'Spezifiert, wer die Version und Build-Nummer von ITBuddy angezeigt bekommt.',
    ...
    'width_w' => 'b',
    'height_h' => 'h',
    'show_url_in_emails' => 'Link zu ITBuddy in E-Mails',
    'show_url_in_emails_help_text' => 'Deaktivieren Sie dieses Kontrollkästchen, wenn Sie in Ihren E-Mail-Fußzeilen keine Verbindung zu Ihrer ITBuddy-Installation herstellen möchten. Nützlich, wenn die meisten Ihrer Benutzer sich nie einloggen.',
    'text_pt' => 'pt',
    ...
    'barcodes_help' => 'Dies wird versuchen, zwischengespeicherte Barcodes zu löschen. Dies wird in der Regel nur verwendet werden, wenn sich die Barcode-Einstellungen geändert haben oder sich Ihre ITBuddy-URL geändert hat. Barcodes werden beim nächsten Zugriff neu generiert.',
    ...
    'label2_2d_target_help' => 'Die Daten, die im 2D Barcode enthalten sein werden. Dies kann direkt mit dem Gegenstand in ITBuddy verbinden oder einer der nicht verknüpften Feldwerte sein. Wenn Sie das Präfix oben verwenden, wird es diesem Wert vorangestellt.',
