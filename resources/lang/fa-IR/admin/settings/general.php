...
',
    ...
    'color_settings_help' => 'These settings will be used throughout ITBuddy.  Users are able to override the link colors by editing their account preferences to meet their individual readability requirements.',
...
',
    ...
    'link_dark_color_help' => 'Select a color that will provide enough contrast for people that use ITBuddy in dark mode.',
    'link_light_color' => 'Link Color for Light Mode',
    'link_light_color_help' => 'Select a color that will provide enough contrast for people that use ITBuddy in light mode.',
...
',
    ...
    'ldap_display_name_help' => 'If you have a separate displayName field in your LDAP/AD, map it here and it will be used for displaying users within ITBuddy.',
    ...
    'ldap_activated_flag_help' => 'This value is used to determine whether a synced user can login to ITBuddy. <strong>It does not affect the ability to check items in or out to them</strong>, and should be the <strong>attribute name</strong> within your AD/LDAP, <strong>not the value</strong>. <br><br>If this field is set to a field name that does not exist in your AD/LDAP, or the value in the AD/LDAP field is set to <code>0</code> or <code>false</code>, <strong>user login will be disabled</strong>. If the value in the AD/LDAP field is set to <code>1</code> or <code>true</code> or <em>any other text</em> means the user can log in. When the field is blank in your AD, we respect the <code>userAccountControl</code> attribute, which usually allows non-suspended users to log in.',
...
',
    ...
    'load_remote_help_text' => 'Uncheck this box if your install cannot load scripts from the outside internet. This will prevent ITBuddy from trying load avatars from Gravatar or other outside sources.',
...
',
    'login_remote_user_custom_logout_url_help' => 'اگر یک URL در اینجا ارائه شود، پس از خروج کاربر از ITBuddy، کاربران به این URL هدایت می شوند. این برای بستن صحیح جلسات کاربر ارائه دهنده احراز هویت شما مفید است.
',
...
',
    ...
    'show_images_in_email_help' => 'اگر نصب ITBuddy شما پشت VPN یا شبکه بسته است و کاربران خارج از شبکه نمی توانند تصاویر ارائه شده از این نصب را در ایمیل های خود بارگیری کنند، علامت این کادر را بردارید.
',
    'site_name' => 'نام سایت',
...
',
    'support_footer_help' => 'مشخص کنید چه کسی پیوندهای اطلاعات پشتیبانی ITBuddy و راهنمای کاربران را ببیند
',
    'version_footer' => 'نسخه در پاورقی
',
    'version_footer_help' => 'مشخص کنید چه کسی نسخه و شماره ساخت ITBuddy را ببیند.
',
...
',
    ...
    'width_w' => 'عرض',
    'height_h' => 'ارتفاع',
    'show_url_in_emails' => 'پیوند به ITBuddy در ایمیل',
    'show_url_in_emails_help_text' => 'اگر نمیخواهید پیوند به نصب ITBuddy خود را در زیرپوشهای ایمیل خود پیگیری کنید، این کادر را بردارید. مفید است اگر اکثر کاربران شما هرگز وارد نشده باشند.',
    'text_pt' => 'بالای صفحه',
...
',
    'barcodes_help' => 'با این کار سعی می شود بارکدهای کش شده را حذف کنید. این معمولاً فقط در صورتی استفاده می شود که تنظیمات بارکد شما تغییر کرده باشد، یا اگر URL ITBuddy شما تغییر کرده باشد. در صورت دسترسی بعدی، بارکدها دوباره تولید خواهند شد.
',
...
',
    ...
    'label2_2d_target_help' => 'The data that will be contained in the 2D barcode. This can link to the asset directly in ITBuddy or can be one of the non-linked field values. If you use the prefix above, it will be prepended to this value.',
