...
return [
    ...
    'webhook_test_msg' => 'مرحبًا! أخبار سعيدة ، يبدو أن نظامك الأن يعمل مع ITBuddy ',
    ...
    'show_or_hide_eulas' => 'مرحبًا! أخبار سعيدة ، يبدو أن نظامك الأن يعمل مع ITBuddy. ',
    'supplier' => 'المورد',
    'suppliers' => 'الموردون',
    ...
    'footer_credit' => '<a target="_blank" href="https://snipeitapp.com" rel="noopener">ITBuddy</a> is open source software, made with <i class="fa fa-heart" aria-hidden="true" style="color: #a94442; font-size: 10px" /></i><span class="sr-only">love</span> by Grokability, Inc.',
