...
return [
    ...
    'login' => 'Најава',
    'login_first_admin' => 'Влезете во новата инсталација на ITBuddy користејќи ги ингеренциите подолу:',
    ...
    'serial' => 'Сериски',
    'snipe_webhook_test' => 'ITBuddy Тест за интеграција',
    'snipe_webhook_summary' => 'ITBuddy Резиме на тест за интеграција',
    'supplier' => 'Добавувач',
    'tag' => 'Таг',
    'test_email' => 'Тест е-пошта од ITBuddy',
    'test_mail_text' => 'Ова е тест од ITBuddy Системот за управување со основни средства. Ако го добивте ова, е-поштата работи :)',
