...
return [
    ...
    'login' => 'ログイン',
    'login_first_admin' => '以下の新しいログイン情報を使用して、ITBuddyにログインします。',
    ...
    'serial' => 'シリアル',
    'snipe_webhook_test' => 'ITBuddy 統合テスト',
    'snipe_webhook_summary' => 'ITBuddy 統合テストの概要',
    'supplier' => '仕入先',
    'tag' => 'タグ',
    'test_email' => 'ITBuddyからのテストメール',
    'test_mail_text' => 'これはITBuddy資産管理システムのテストです。あなたがこれを読めているなら、メール機能は動作しています:)',
    ...
    'your_credentials' => 'ITBuddy クレデンシャル',
