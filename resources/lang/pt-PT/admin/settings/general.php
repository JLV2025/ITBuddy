...
return [
    ...
    'login_remote_user_custom_logout_url_help' => 'Se preenchido, os utilizadores serão redirecionados para este URL depois de fecharem a sessão no ITBuddy. É particularmente útil para fechar corretamente a sessão do utilizador do fornecedor de autenticação.',
    ...
    'show_images_in_email_help' => 'Desmarque esta caixa se a sua instalação do ITBuddy estiver a correr através de uma VPN ou rede fechada e utilizadores fora da rede não conseguirem carregar as imagens desta instalação nos seus e-mails.',
    ...
    'snipe_version' => 'Versão ITBuddy',
    'support_footer' => 'Links de rodapé de suporte',
    'support_footer_help' => 'Especifica quem vê os links de Suporte e Manual de utilizador do ITBuddy',
    ...
    'width_w' => 'w',
    'height_h' => 'h',
    'show_url_in_emails' => 'Link para ITBuddy em E-mails',
    'show_url_in_emails_help_text' => 'Desmarque esta caixa se não deseja vincular novamente a sua instalação ITBuddy em seus rodapés de e-mail. Útil se a maioria de seus usuários nunca logar.',
    'text_pt' => 'pt',
    ...
    'barcodes_help' => 'Isto irá apagar códigos de barras em cache. Isto normalmente só deveria ser usado se as configurações do código de barras tivessem sido alteradas, ou se a URL do ITBuddy tivesse sido alterada. Códigos de barras serão novamente gerados quando forem acedidos.',
