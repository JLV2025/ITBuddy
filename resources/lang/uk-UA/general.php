...
return [
    ...
    'webhook_test_msg' => 'О, клас! Здається, що ваша інтеграція з ITBuddy працює!',
    ...
    'footer_credit' => '<a target="_blank" href="https://snipeitapp.com" rel="noopener">ITBuddy</a> — це програмне забезпечення з відкритим вихідним кодом, створене з <i class="fa fa-heart" aria-hidden="true" style="color: #a94442; font-size: 10px" /></i><span class="sr-only">любов\'ю</span> компанією Grokability, Inc.',
