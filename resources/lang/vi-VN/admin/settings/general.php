...
return [
    ...
    'login_remote_user_custom_logout_url_help' => 'Nếu một liên kết url được cung cấp ở đây, người dùng sẽ được chuyển hướng đến liên kết URL này sau khi người dùng đăng xuất khỏi ITBuddy. Điều này hữu ích để đóng các phiên người dùng của nhà cung cấp Xác thực bạn một cách chính xác.',
    ...
    'show_images_in_email_help' => 'Bỏ chọn hộp này nếu cài đặt ITBuddy của bạn nằm sau VPN hoặc mạng riêng tư và người dùng bên ngoài mạng sẽ không thể tải hình ảnh được cung cấp từ cài đặt này trong email của họ.',
    ...
    'snipe_version' => 'Phiên bản ITBuddy',
    'support_footer' => 'Hỗ trợ liên kết ở chân trang ',
    'support_footer_help' => 'Chỉ định ai nhìn thấy các liên kết đến Thông tin người dùng và Hướng dẫn sử dụng ITBuddy',
    'version_footer' => 'Hiển thị phiên bản ở cuối trang ',
    'version_footer_help' => 'Chỉ định ai xem phiên bản ITBuddy và số bản dựng.',
    ...
    'width_w' => 'w',
    'height_h' => 'h',
    'show_url_in_emails' => 'Liên kết đến ITBuddy trong email',
    'show_url_in_emails_help_text' => 'Bỏ chọn hộp này nếu bạn không muốn liên kết lại với cài đặt ITBuddy của mình trong phần chân trang email. Có ích nếu hầu hết người dùng của bạn không đăng nhập.',
    'text_pt' => 'pt',
