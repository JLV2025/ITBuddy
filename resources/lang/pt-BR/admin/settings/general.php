...
return [
    ...
    'load_remote_help_text' => 'Desmarque essa caixa se a sua instalação não pode carregar scripts vindos da internet. Isso vai prevenir que o ITBuddy carregue avatares do Gravatar ou outras fontes externas.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Se uma URL for inserida aqui, os usuários serão redirecionados para a essa URL após desconectarem do ITBuddy. Isso pode ser útil para encerrar sessões com o seu provedor de Autenticação corretamente.',
    ...
    'show_images_in_email_help' => 'Desmarque esta caixa se sua instalação de ITBuddy está por trás de uma VPN ou rede fechada e usuários fora da rede não será capazes de carregar imagens, servidas a partir desta instalação em seus e-mails.',
    ...
    'snipe_version' => 'Versão do ITBuddy',
    'support_footer' => 'Links de rodapé de suporte ',
    'support_footer_help' => 'Especifique quem vê os links para as informações de Suporte ITBuddy e o Manual do Usuário',
    ...
    'barcodes_help' => 'Isto tentará apagar códigos de barras em cache. Isso normalmente só seria usado se as configurações do código de barras tivessem sido alteradas, ou se a URL do ITBuddy tivesse sido alterada. Códigos de barras serão re-gerados quando acessados em seguida.',
