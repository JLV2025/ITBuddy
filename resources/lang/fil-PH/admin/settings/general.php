...
return [
    ...
    'login_remote_user_custom_logout_url_help' => 'If a url is provided here, users will get redirected to this URL after the user logs out of ITBuddy. This is useful to close the user sessions of your Authentication provider correctly.',
    ...
    'snipe_version' => 'Ang bersyon ng ITBuddy',
    'support_footer' => 'Sumusuporta ng mga Link ng Footer ',
    'support_footer_help' => 'I-specify kung sino ang nakakakita ng mga link sa impormasyon ng ITBuddy Support at ang mga User Manual',
    'version_footer' => 'Version in Footer ',
    'version_footer_help' => 'Specify who sees the ITBuddy version and build number.',
    ...
    'width_w' => 'w',
    'height_h' => 'h',
    'show_url_in_emails' => 'I-link ang ITBuddy sa mga Email',
    'show_url_in_emails_help_text' => 'I-uncheck ang box na ito kung hindi mo gustong mag-link pabalik sa pag-install ng ITBuddy sa mga footers ng iyong email. Ito ay kapaki-pakinabang kung karamihan sa iyong mga gumagamit ay kailanman hindi mag-login. ',
    'text_pt' => 'pt',
    ...
    'barcodes_help' => 'This will attempt to delete cached barcodes. This would typically only be used if your barcode settings have changed, or if your ITBuddy URL has changed. Barcodes will be re-generated when accessed next.',
