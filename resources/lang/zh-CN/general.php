...
return [
    ...
    'webhook_test_msg' => '哦哈！看起来您的 :app 与ITBuddy 的整合工作正常！',
    ...
    'footer_credit' => '<a target="_blank" href="https://snipeitapp.com" rel="noopener">ITBuddy</a> 是开源软件，用 <i class="fa fa-heart" aria-hidden="true" style="color: #a94442; font-size: 10px" /></i><span class="sr-only">爱</span> 由 Grokability, Inc. 制作。',
    'set_password' => '设置密码',
