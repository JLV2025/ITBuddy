...
return [
    ...
    'webhook_test_msg' => 'Ciao! Sembra che l\'integrazione di :app su ITBuddy funzioni!',
...
<p>Per esportare solamente alcune risorse, utilizzare le opzioni che seguono per filtrare i risultati.</p>',
    ...
    'footer_credit' => '<a target="_blank" href="https://snipeitapp.com" rel="noopener">ITBuddy</a>è un software open source, realizzato con <i class="fa fa-heart" aria-hidden="true" style="color: #a94442; font-size: 10px" /></i><span class="sr-only">amore</span> da Grokability, Inc.',
