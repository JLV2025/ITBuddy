...
return [
    ...
    'login' => 'Είσοδος',
    'login_first_admin' => 'Συνδεθείτε στη νέα σας εγκατάσταση ITBuddy χρησιμοποιώντας τα παρακάτω διαπιστευτήρια:',
    ...
    'serial' => 'Σειριακός',
    'snipe_webhook_test' => 'ITBuddy Δοκιμή Ολοκλήρωσης',
    'snipe_webhook_summary' => 'Σύνοψη Δοκιμής Ενσωμάτωσης ITBuddy',
    'supplier' => 'Προμηθευτές',
    'tag' => 'Ετικέτα',
    'test_email' => 'Έλεγχος email για ITBuddy',
    'test_mail_text' => 'Πρόκειται για μια δοκιμή από το σύστημα διαχείρισης περιουσιακών στοιχείων της ITBuddy. Αν το έχετε, το mail λειτουργεί :)',
    ...
    'your_credentials' => 'Τα διαπιστευτήρια σας ITBuddy',
