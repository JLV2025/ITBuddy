...
return [
    ...
    'backups_restore_warning' => 'Utilice el botón de restauración <small><span class="btn btn-xs btn-warning"><i class="text-white fas fa-retweet" aria-hidden="true"></i></span></small> para restaurar desde una copia de seguridad anterior. (Esto no funciona con almacenamiento de archivos S3).<br><br>Su <strong>base de datos completa de :app_name y cualquier archivo cargado será completamente reemplazado</strong> por lo que hay en la copia de seguridad.  ',
    ...
    'color_settings_help' => 'Estos ajustes se utilizarán a través de ITBuddy. Los usuarios pueden anular los colores de los enlaces editando sus preferencias de cuenta para cumplir con sus requisitos individuales de legibilidad.',
    ...
    'link_dark_color_help' => 'Seleccione un color que proporcionará suficiente contraste para las personas que usan ITBuddy en modo oscuro.',
    'link_light_color' => 'Color de enlace para modo Claro',
    'link_light_color_help' => 'Selecciona un color que proporcione suficiente contraste para las personas que utilicen ITBuddy en modo Claro.',
    ...
    'ldap_location' => 'Campo de ubicación LDAP',
    ...
    'ldap_manager' => 'Campo Administrador LDAP',
    ...
    'ldap_email' => 'Campo Correo Electrónico LDAP',
    'ldap_mobile' => 'Campo Número Móvil LDAP',
    'ldap_address' => 'Campo Dirección LDAP',
    'ldap_city' => 'Campo ciudad LDAP',
    'ldap_state' => 'Campo LDAP Estado/Provincia',
    'ldap_zip' => 'Campo Código Postal LDAP',
    ...
    'load_remote_help_text' => 'Desmarque esta casilla si su instalación no puede cargar secuencias de comandos (scripts) desde Internet . Esto evitará que ITBuddy intente cargar avatares de Gravatar u otras fuentes externas.',
    ...
    'login_remote_user_custom_logout_url_help' => 'Si se proporciona una URL aquí, los usuarios serán redirigidos a esta URL después de que el usuario cierre la sesión de ITBuddy. Esto es útil para cerrar correctamente las sesiones de usuario de su proveedor de autenticación.',
    ...
    'show_images_in_email_help' => 'Desmarque esta casilla si su instalación de ITBuddy está detrás de una red privada o VPN y los usuarios fuera de la red no pueden cargar las imágenes publicadas desde este servidor de ITBuddy en sus correos electrónicos.',
    ...
    'snipe_version' => 'Versión de ITBuddy',
    'support_footer' => 'Enlace al soporte en el pie de página ',
    'support_footer_help' => 'Especifique quién puede ver los enlaces a la información de soporte de ITBuddy y al manual de usuario.',
    'version_footer' => 'Versión en el pie de página ',
    'version_footer_help' => 'Especifique quién puede ver la versión de ITBuddy y el número de compilación.',
    ...
    'width_w' => 'ancho',
    'height_h' => 'alto',
    'show_url_in_emails' => 'Enlace a ITBuddy en correos electrónicos',
    'show_url_in_emails_help_text' => 'Desmarque esta casilla si no desea vincular su instalación de ITBuddy en el pie de página de correo electrónico. Útil si la mayoría de sus usuarios nunca se conectan. ',
    'text_pt' => 'puntos',
    ...
    'barcodes_help' => 'Esto intentará eliminar códigos de barras almacenados en caché. Normalmente solo se usa si la configuración del código de barras ha cambiado o si ha cambiado la URL de ITBuddy. Los códigos de barras se volverán a generar la próxima vez que se acceda a ellos.',
