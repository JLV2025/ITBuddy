...
return [
    ...
    'color_settings_help' => 'Тези настройки ще бъдат използвани в ITBuddy. Потребителите ще могат да изберат свой собствени настройки на цвета на връзките от техните настройки през акаунта.',
    ...
    'link_dark_color_help' => 'Изберете цвят, който има достатъчно контраст за хората, който ползват ITBuddy в тъмен режим.',
    'link_light_color' => 'Цвят на връзките за светъл режим',
    'link_light_color_help' => 'Изберете цвят, който има достатъчно контраст за хората, който ползват ITBuddy в светъл режим.',
    ...
    'ldap_display_name_help' => 'Ако имате отделно displayName поле във вашия LDAP/AD, свържете го тук и то ще бъде име за покзване в ITBuddy.',
    ...
    'load_remote_help_text' => 'Премахнете отметката от това квадратче, ако вашата инсталация не може да зареди скриптове от външен интернет. Това ще попречи на ITBuddy да се опита да зареди аватари от Gravatar или други външни източници.',
    'login' => 'Опити за вход',
    ...
    'login_remote_user_custom_logout_url_help' => 'Ако уеб адреса е вписън тук, потребителите ще бъдат препратени към този URL след като излязат от ITBuddy. Това е препоръчително за да се затвори сесията от доставчика на удостоверения правилно.',
    ...
    'snipe_version' => 'ITBuddy версия',
    'support_footer' => 'Връзки към Snipe-it поддръжката във футъра',
    'support_footer_help' => 'Указва визуализацията на връзки към поддръжката на ITBuddy и потребителската документация',
    'version_footer' => 'Версия в долен колонтитул ',
    'version_footer_help' => 'Определя кой ще вижда ITBuddy версията и номера на компилация.',
    ...
    'width_w' => 'w',
    'height_h' => 'h',
    'show_url_in_emails' => 'Връзка към ITBuddy в имейли',
    'show_url_in_emails_help_text' => 'Премахнете отметката от тази кутийка, ако не желаете да свържете обратно към вашата ITBuddy инсталация в досиетата ви за електронна поща. Полезно, ако повечето от вашите потребители никога не влизат в системата.',
    'text_pt' => 'pt',
    ...
    'barcodes_help' => 'Това ще изтрие кеша на баркодовете. Това обикновено се използва при промяна на баркод настройките или при промяна на ITBuddy URL адреса. Баркодовете ще бъдат генерирани отново.',
    ...
    'label2_2d_target_help' => 'Тази информация ще бъде добавена в 2D баркод. Това може да е връзка към актив директно в ITBuddy или към поле което не е свързано със стойност. Ако използвате този префикс отгоре, той ще бъде добавен към тази стойност.',
