...
return [
    ...
    'Accessory_Checkout_Notification' => 'Zubehör ausgecheckt|:count Zubehör ausgecheckt',
    'Asset_Checkin_Notification' => 'Asset eingecheckt in: :tag',
    'Asset_Checkout_Notification' => 'Asset ausgebucht: :tag',
    'Confirm_Accessory_Checkin' => 'Bestätigung einer Zubehör Rücknahme',
    'Confirm_Asset_Checkin' => 'Bestätigung einer Asset Rücknahme',
    'Confirm_component_checkin' => 'Bestätigung der Rücknahme von Komponenten',
    ...
    'Confirm_component_delivery' => 'Bestätigung der Herausgabe von Komponenten',
    ...
    'Expected_Checkin_Date_Past' => 'Ein an Dich ausgechecktes Asset sollte am :date erneut eingecheckt werden.',
    ...
    'acceptance_asset_accepted_to_user' => 'Du hast einen Gegenstand akzeptiert, der Dir von :site_name zugewiesen wurde|Du hast :qty Gegenstände akzeptiert, die Dir von :site_name zugewiesen wurden',
    ...
    'admin_has_created' => 'Ein Administrator hat für Dich ein Konto auf der Website :web erstellt. Nachstehend findest Du Deinen Benutzernamen. Klicke auf den Link, um ein Passwort festzulegen.',
    'asset' => 'Asset',
    ...
    'initiated_accepted' => 'Eine von Dir initiierte Herausgabe wurde akzeptiert',
    'initiated_declined' => 'Eine von Dir initiierte Herausgabe wurde abgelehnt',
    ...
    'login' => 'Anmelden',
    'login_first_admin' => 'Melde Diche zu Deiner neuen ITBuddy-Installation mithilfe der unten stehenden Anmeldeinformationen an:',
    ...
    'name' => 'Name',
    'new_item_checked' => 'Ein neuer Gegenstand wurde unter Deinem Namen wurde ausgebucht, Details sind unten aufgeführt.|:count neue Gegenstände wurden unter Deinem Namen ausgebucht, Details sind unten aufgeführt.',
    'new_item_checked_with_acceptance' => 'Ein neuer Gegenstand wurde unter Deinem Namen ausgebucht, der Deine Annahme erfordert, Details sind unten aufgeführt.|:count neue Gegenstände wurden unter Deinem Namen ausgebucht, die Deine Annahme erfordert, Details sind unten aufgeführt.',
    ...
    'items_checked_out_require_acceptance' => 'Der eingecheckte Gegenstand benötigt die Zustimmung. |Ein oder mehrere Artikel benötigen die Zustimmung.',
    ...
    'click_here_to_review_terms_and_accept_item' => 'Klick hier, um die Nutzungsbedingungen zu überprüfen und den Gegenstand anzunehmen|Klick hier, um die Nutzungsbedingungen zu überprüfen und die Artikel zu akzeptieren',
    'requested' => 'Angefragt',
    'reset_link' => 'Sein Link zum Zurücksetzen des Kennworts',
    'reset_password' => 'Klicke hier, um Dein Passwort zurückzusetzen:',
    'rights_reserved' => 'Alle Rechte vorbehalten.',
    'serial' => 'Seriennummer',
    'snipe_webhook_test' => 'ITBuddy Integrationstest',
    'snipe_webhook_summary' => 'ITBuddy Integration Test Zusammenfassung',
    'supplier' => 'Lieferant',
    'tag' => 'Kennzeichnung',
    'test_email' => 'Test E-Mail von ITBuddy',
    'test_mail_text' => 'Dies ist ein Test des ITBuddy Asset Management Systems. Wenn du das erhalten hast, funktioniert das Senden von Mails :)',
    ...
    'upcoming-audits_click' => 'Diese E-Mail enthält möglicherweise nicht die vollständige Liste, um die Größenbeschränkung der E-Mail nicht zu überschreiten. Klick auf die Schaltfläche unten, um alle zum Audit fälligen Assets anzuzeigen.',
    'user' => 'Benutzer',
    'username' => 'Benutzername',
    'unaccepted_asset_reminder' => 'Erinnerung: Du hast nicht akzeptierte Assets',
    'welcome' => 'Willkommen, :name',
    'welcome_to' => 'Willkommen bei :web!',
    'your_assets' => 'Deine Assets anzeigen',
    'your_credentials' => 'Ihre ITBuddy Anmeldedaten',
