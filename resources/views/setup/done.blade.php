...
@section('content')
    ...
    <div class="col-md-12">
        ...
        <p>
            If you're already familiar with ITBuddy, you can get started right away by <strong><a href="{{ config('app.url') }}">heading right to your dashboard</a></strong>, or if it's your first time using ITBuddy, you can check out some of the useful resources below:
        </p>
        ...
        <div class="well well-sm well-warning">
            ...
            <p>
                ...
                make sure the username format for any users imported via CSV matches your directory service username format to avoid duplicating users in ITBuddy.
            </p>
        </div>
